 ...
 */
@ForChange(isMajor = true, expectedVersionForChange = "1.24.1", reason = "JException class only has Reasons for Errors, and it's not really Versatile, which makes it a big deal, so it's getting changed.")
