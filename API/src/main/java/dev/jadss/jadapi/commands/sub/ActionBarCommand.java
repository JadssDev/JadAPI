...
public class ActionBarCommand {
    ...
    public ActionBarCommand(CommandSender sender, String[] args) {
        if(sender instanceof ConsoleCommandSender || sender.hasPermission("JadAPI.sendActionBar")) {
            ...
            if(args[1].equalsIgnoreCase("*")) {
                ...
                if(player != null && player.isOnline()) {
                    new JPlayer(player).sendActionBar(ChatColor.translateAlternateColorCodes('&', message));
                } else {
