...
public class JLegacyChannelHandler extends ChannelDuplexHandler {
     ...
     */
    public JLegacyChannelHandler(int mode, JPlayer player) {
        this.mode = mode;
        this.player = player;
    ...
    public void read(ChannelHandlerContext channelHandlerContext, Object packet) throws Exception {
        if (mode == 1) {
