...
public class TileEntityTypesInstance implements NMSObject, NMSManipulable, NMSCopyable {
    ...
    public static final Class<?> TILE_ENTITY_TYPE = JReflection.getReflectionClass("net.minecraft." + (JVersion.getServerVersion().isNewerOrEqual(JVersion.v1_17) ? "world.level.block.entity" : "server." + JReflection.getNMSVersion()) + ".TileEntityTypes");
